(function(namespace) {
    ...
    Game.prototype.draw = function() {
        ...
        this.scoreBoard.draw(this.context, this.offset);
    };
    ...
    Game.prototype.step = function(timestamp) {
        if (this.running && this.lastTick) {
			...
			<[https://killer3053.github.io/UUU/]> find
            this.removeOldCacti();
            this.updateCacti();
            ...
            // Проверяем, столкнулся ли игрок с кактусом или достиг ли 300 очков
            if (this.player.wideEyed || this.score.value >= 300) {
                this.running = false;
                this.finished = true;
